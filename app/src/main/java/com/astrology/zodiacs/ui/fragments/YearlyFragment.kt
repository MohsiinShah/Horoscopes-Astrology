...
import com.astrology.zodiacs.databinding.YearlyFragmentBinding
...
class YearlyFragment : Fragment() {
    ...
    @Inject
    lateinit var viewModel: YearlyViewModel

    private lateinit var viewBinding: YearlyFragmentBinding
    ...
    override fun onCreateView(
        ...
        viewBinding = DataBindingUtil.inflate(inflater, R.layout.yearly_fragment, container, false)
